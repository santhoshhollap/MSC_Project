...
# from .loss_helper import FSAuxCELoss, FSAuxRMILoss, FSCELoss
...
class ContrastAuxCELoss(nn.Module, ABC):
    ...
    def forward(self, preds, target, embedding):
        ...
        loss_contrast = self.contrast_criterion(embedding, target, preds)
